...
#set directories (note: data were accessed from the EDI repository above and 
#stored on an internal server because of GitHub file size limitations. Paths
#will need to be updated by individual external users)
datin <- "/Volumes/enhydra/data/kelp_recovery/kelp_landsat/raw"
datout <- "/Volumes/enhydra/data/kelp_recovery/kelp_landsat/processed"
