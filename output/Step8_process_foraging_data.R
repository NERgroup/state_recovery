...
#set directories 
datin <- "/Volumes/enhydra/data/foraging_data/raw"
datout <- "/Volumes/enhydra/data/foraging_data/processed"

#get metadata 
meta_raw <- read_xlsx(file.path(datin, "ForageKey_lookup_table.xlsx"))

#get foraging data
for_dat <- read_xlsx(file.path(datin, "Forage_data_2024&2025.xlsx"))
dives <- read_xlsx(file.path(datin, "Forage_dives_2024&2025.xlsx"))
index <- read_xlsx(file.path(datin, "Forage_index_2024&2025.xlsx"))
...
write.csv(data_build3, file.path(datout, "foraging_data_2024_2025_processed.csv"), row.names=FALSE)
